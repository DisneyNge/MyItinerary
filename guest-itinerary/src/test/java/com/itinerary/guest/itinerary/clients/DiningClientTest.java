...
public class DiningClientTest {

	@Test
	public void test1() throws Exception {

		DiningClient diningClient = new DiningClient();

		HttpClient httpClient = EasyMock.createMock(HttpClient.class);

		diningClient.setHttpClient(httpClient);
